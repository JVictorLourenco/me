  ...
  return (
    <div className="flex flex-col items-center justify-center w-screen h-screen overflow-hidden bg-gradient-to-tl from-black via-zinc-600/30 to-black">
      ...
      <div className="my-12 text-center animate-fade-in">
        <h2 className="text-sm text-zinc-500 max-w-3xl px-5">
          I'm João Victor R. Lourenco, a Software Engineer with 4+ years of
          full-stack experience. I excel in developing robust solutions across
          the stack, with a strong engineering background and proficiency in
          multiple programming languages. Let's push the boundaries of
          technology together.
          <br />
        </h2>
      </div>
